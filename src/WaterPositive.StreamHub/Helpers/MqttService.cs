...
namespace WaterPositive.StreamHub.Helpers
{
    ...
    public class MqttService
    {
        ...
        public readonly string? DataTopic = ConfigurationManager.AppSettings["DataTopic"];
        public readonly string? ControlTopic = ConfigurationManager.AppSettings["ControlTopic"];
        ...
        public Task SendTelemetry(string DeviceId, bool[] Coils, int[] Registers)
        {
            ...
            return Task.Factory.StartNew(() => {
                var action = new { DeviceId = DeviceId, Coils = Coils, Registers = Registers };
