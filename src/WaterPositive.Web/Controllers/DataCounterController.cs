...
namespace WaterPositive.Web.Controllers
{
    ...
    [ApiController]
    public class DataCounterController : ControllerBase
    {
        DataCounterService service;
        public DataCounterController(DataCounterService service)
        {
        ...
        [HttpPost("InsertData")]
        public IActionResult InsertData([FromForm] DataCounter data)
        {
            var datas = service.InsertData(data);
            return Ok(datas);
        }
        [HttpPut("UpdateData")]
        public IActionResult UpdateData([FromForm] DataCounter data)
        {
