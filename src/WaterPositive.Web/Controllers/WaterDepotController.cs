...
namespace WaterPositive.Web.Controllers
{
    ...
    [ApiController]
    public class WaterDepotController : ControllerBase
    {
        WaterDepotService service;
        public WaterDepotController(WaterDepotService service)
        {
        ...
        [HttpPost("InsertData")]
        public IActionResult InsertData([FromForm] WaterDepot data)
        {
            var datas = service.InsertData(data);
            return Ok(datas);
        }
        [HttpPut("UpdateData")]
        public IActionResult UpdateData([FromForm] WaterDepot data)
        {
